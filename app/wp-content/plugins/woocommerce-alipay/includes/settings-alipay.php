  ...
  'enabled' => array(
    ...
    'default'       => 'no',
      ...
      'description' => array(
            ...
            'type'          => 'text',
            'desc_tip'      => true,
            'description'   => __( 'This controls description which the user sees during checkout', 'woocommerce' ),
            'default'       => '使用支付宝支付。',
      ),
      'app_id' => array(
            'title'         => 'App ID',
      ...
      'merchant_private_key' => array(
            ...
            'type'          => 'textarea',
            'desc_tip'      => true,
            'description'   => '在蚂蚁金服开放平台 - 密钥管理里面，可以设置应用的公钥，这里要填写的是对应的应用公钥。',
            'default'       => '',
